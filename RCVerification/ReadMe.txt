========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet RCVerification
========================================================================

AppWizard a créé cette application RCVerification pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application RCVerification.


RCVerification.vcxproj
...
RCVerification.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé RCVerification.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
